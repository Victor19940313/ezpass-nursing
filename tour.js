    ...
    home: {
      ...
      steps: [
        ...
        },
        {
          s: 'a.card[href^="exam/"]',
          t: "練習本 — 主戰場",
          b: "" + SITE.yearSpanText + "歷屆、" + (typeof QUESTIONS !== "undefined" ? QUESTIONS.length : "全部") + " 題，作者已全部分門別類。照試卷練或照單元練，每題都能標記，錯的會自動整理。",
        },
        {
    ...
    examHome: {
      ...
      steps: [
        ...
        },
        {
          s: "#hm-topic",
          t: "照單元練 — 最厲害的功能之一",
          b: "" + (typeof QUESTIONS !== "undefined" ? QUESTIONS.length : "全部") + " 題已全部分門別類。挑一個單元，把 11 年來同一個觀念的題目一次寫熟、集中火力。每個單元做過幾題、錯誤率多少一眼看到。",
        },
        {
          s: "#home-how",
          t: "作答方式",
